...
abstract class ContentRemoteDataSource {
  ...
  Future<void> deleteLessonsByTopic(String userId, String subjectName, String topicName);
...
class ContentRemoteDataSourceImpl implements ContentRemoteDataSource {
  ...
  @override
  Future<void> deleteLessonsByTopic(String userId, String subjectName, String topicName) async {
    try {
  ...
  Future<List<LessonModel>> getUserLessons(String userId) async {
    try {
      ...
      return querySnapshot.docs
          .map((doc) => LessonModel.fromFirestore(doc.id, doc.data() as Map<String, dynamic>))
          .toList();
    } catch (e) {
    ...
    try {
      ...
      for (final lesson in lessons) {
        if (lesson.id.isEmpty) {
          ...
          batch.update(_lessonsCollection.doc(lesson.id), lesson.toFirestore());
        }
      }
