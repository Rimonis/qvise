// lib/core/shell_and_tabs/profile_tab.dart
...
import 'package:qvise/core/widgets/theme_mode_list_tile.dart';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  // Use the dedicated widget for theme selection
  ...
  Future<void> _handleLogout(BuildContext context, WidgetRef ref) async {
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(e is AppFailure ? e.message : 'An unknown error occurred'),
            backgroundColor: AppColors.error,
          ),
        );
      }
